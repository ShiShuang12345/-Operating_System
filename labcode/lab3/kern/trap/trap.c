...
void exception_handler(struct trapframe *tf) {
    switch (tf->cause) {
        ...
        case CAUSE_ILLEGAL_INSTRUCTION:
             // 非法指令异常处理
             /* LAB3 CHALLENGE3   YOUR CODE :2312345薄照轩 2312848石爽 2313827马思远  */
            ...
            */
            ...
            tf->epc += 4;  // 关键：跳过4字节的ebreak指令
            break;
        case CAUSE_BREAKPOINT:
            //断点异常处理
            /* LAB3 CHALLLENGE3   YOUR CODE :2312345薄照轩 2312848石爽 2313827马思远  */
