...
alloc_proc(void)
{
    ...
    if (proc != NULL)
    {
        ...
        //LAB8 YOUR CODE 2312345 (update LAB6 steps)
        /*
         * below fields(add in LAB6) in proc_struct need to be initialized
...
void proc_run(struct proc_struct *proc)
{
    // LAB4:填写你在lab4中实现的代码
        ...
        */
    //LAB8 YOUR CODE 2312345 (update LAB4 steps)
      /*
       * below fields(add in LAB6) in proc_struct need to be initialized
...
int do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf)
{
    ...
    ret = -E_NO_MEM;
    // LAB8:EXERCISE2 YOUR CODE 2312345  HINT:how to copy the fs in parent's proc_struct?
    // LAB4:填写你在lab4中实现的代码
    /*
     * Some Useful MACROs, Functions and DEFINEs, you can use them in below implementation.
     * MACROs or Functions:
...
{
    /* LAB8:EXERCISE2 YOUR CODE 2312345 HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
